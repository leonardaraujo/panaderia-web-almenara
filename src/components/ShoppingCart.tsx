            ...
            {step === 'payment' && (
              <div className="p-2">
                <div className="alert alert-info">
                  ...
                  <p className="mb-0">Para finalizar tu compra, revisa los detalles y confirma tu pedido.</p>
                </div>
                ...
                <div className="card mb-3 border-0 bg-light">
                  <div className="card-body">
                    ...
                    <p className="mb-1"><strong>Ciudad:</strong> {shippingInfo.city}</p>
                ...
                <div className="card mb-3 border-0 bg-light">
                  <div className="card-body">
                    ...
                    {items.map((item) => (
                      <div key={item.name} className="d-flex justify-content-between mb-2">
                        <span>
          ...
          <div className="modal-footer">
            {step === 'cart' && items.length > 0 && (
              <>
                ...
                <button className="btn btn-danger" onClick={() => setStep('shipping')}>
            ...
            {step === 'payment' && (
              <>
                <button className="btn btn-outline-secondary" onClick={() => setStep('shipping')}>
                  Volver
                </button>
...
const FaShoppingCart = ({ size, className }: { size: number, className: string }) => (
  <svg 
