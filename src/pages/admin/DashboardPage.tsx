...
const DashboardPage: React.FC = () => {
	...
	// Si no hay usuario autenticado o no es admin, no renderizar nada
	if (!isAuthenticated || !isAdmin()) {
		return null;
	}
					...
					<div className="card-body">
						<div className="d-flex justify-content-between align-items-start">
							<div>
								...
								<h3 className="mb-0">
									{ordersList.filter((o) => o.status === "en proceso").length}
								</h3>
							</div>
					...
					<div className="card-body">
						<div className="d-flex justify-content-between align-items-start">
							<div>
								...
								<h3 className="mb-0">
									{ordersList.filter((o) => o.status === "entregado").length}
								</h3>
							</div>
